...
Kit version: `2026.8.31` · 24 agents · 56 skills · 15 workflows
...
flowchart LR
  ...
  subgraph Agents
    ...
    A_business_analyst["business-analyst"]
    ...
    A_system_architect["system-architect"]
    A_test_engineer["test-engineer"]
    A_ui_ux_designer["ui-ux-designer"]
  end
  subgraph Skills
    S_advanced_elicitation["advanced-elicitation"]
    S_api_patterns["api-patterns"]
    S_app_builder["app-builder"]
    S_architecture["architecture"]
    S_ast_grep["ast-grep"]
    S_ba_diagrams["ba-diagrams"]
    ...
    S_git_master["git-master"]
    S_gsap_skills["gsap-skills"]
  ...
  W_commit --> A_orchestrator
  W_commit -.-> S_git_master
  W_commit -.-> S_clean_code
  ...
  W_party --> A_product_manager
  W_party --> A_ui_ux_designer
  W_party --> A_system_architect
  W_party --> A_frontend_specialist
  W_party --> A_backend_specialist
  W_party -.-> S_advanced_elicitation
  W_party -.-> S_architecture
  W_party -.-> S_design_spec
  W_party -.-> S_clean_code
  ...
  A_debugger --> S_silent_failure_hunter
  A_debugger --> S_ast_grep
  ...
  A_frontend_specialist --> S_taste_skill
  A_frontend_specialist --> S_gsap_skills
  ...
  A_plan_checker --> S_plan_writing
  A_plan_checker --> S_clean_code
  ...
  A_system_architect --> S_architecture
  A_system_architect --> S_api_patterns
  A_system_architect --> S_database_design
  ...
  A_ui_ux_designer --> S_design_spec
  A_ui_ux_designer --> S_frontend_design
  A_ui_ux_designer --> S_web_design_guidelines
  A_ui_ux_designer --> S_taste_skill
  A_ui_ux_designer --> S_clean_code
  A_ui_ux_designer --> S_advanced_elicitation
```
